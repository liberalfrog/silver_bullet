import sys
import scripts.splitAndFilter as sp
import scripts.classfiedAbstractTag as ab
import scripts.classfiedFigurativeTag as fig
import json

#画像データは辞書で画像がキーでタグのリストがバリュー
def setImageDataJson(imagePath,tags):
    p=""
    path="datas/imagesData.json"
...
def fromSubjectToImagePath(subjectStr):
    splitedSub = sp.splitWord(subjectStr)

    imagePath="datas/imagesData.json"
    matchTagList = []
    matchDic={}
    savedTags={}
